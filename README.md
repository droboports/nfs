# nfs ![](https://travis-ci.org/droboports/nfs.svg?branch=master)
...
Check the [releases](https://github.com/droboports/nfs/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/nfs.git
cd nfs
./build.sh
ls -la *.tgz
```
